...
for i in {1..20}; do
    ...
    Rscript feols_bootstrap_regressions_modified.R $i 50 "FALSE" "FALSE"  >> logs/output_$i.log 2>&1 &
    ...
    python project_damages_modified.py $i 50 0 0 >> logs/output_$i.log 2>&1 &
